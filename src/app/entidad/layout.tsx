...
const sidebarNavItems = [
  { title: "Dashboard", href: "/entidad", icon: LayoutDashboard },
  { title: "Estadísticas", href: "/entidad/estadisticas", icon: BarChart3 },
  { title: "Reportes", href: "/entidad/reportes", icon: FileText },
  { title: "Instituciones", href: "/entidad/instituciones", icon: Building2 },
  { title: "Configuración", href: "/entidad/configuracion", icon: Settings },
]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className={cn(
        ...
        <div className="flex h-16 items-center justify-between border-b px-4">
          <Link href="/entidad" className="flex items-center gap-2">
      ...
      <div className="lg:ml-64 min-h-screen flex flex-col">
        <header className="sticky top-0 z-30 flex h-14 sm:h-16 items-center gap-4 border-b bg-white px-4 sm:px-6 shadow-sm">
          ...
          <span className="text-xs sm:text-sm text-muted-foreground hidden md:block">Entidad Gubernamental</span>
